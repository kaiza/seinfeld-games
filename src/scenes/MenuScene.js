...
const GAMES = [
  ...
  { key: 'FestivusScene', title: 'Festivus Feats of Strength', description: 'Button-mash wrestle Frank Costanza to end Festivus!' },
  { key: 'MailChaosScene', title: 'Mail Route Chaos', description: 'Deliver mail while dodging dogs, rain, and your own laziness!' },
